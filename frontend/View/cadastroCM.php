       ...
       <div class="container">
            <div class="row">
                <div class="d-flex justify-content-center checkout" >
                    <form id="formCadCM" action="../View/enderecoCadCM.php" method="post">
                        <h3 class="tituloCad">Cadastre-se e faça parte</h3>
                        <small id="nome" class="form-text text-muted">Caro Profissional, nunca vamos compartilhar seus dados com ninguém.</small>
                        <br>
                        <small id="hf" class="hf">Por favor preencha todos os campos corretamente</small>
                        <div class="form-group">
                          <br>
                          <label for="nome">Nome</label>
                          <input type="text" name="nomeCM" class="form-control" id="nomeCM" aria-describedby="nome" placeholder="Nome">
                        </div>
                        <br>
                        <div class="form-group">
                          <label for="sobrenome">Sobrenome</label>
                          <input type="text" name="sobrenomeCM"  class="form-control" id="sobrenomeCM" placeholder="Sobrenome">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="dataNascimento">Data de Nascimento</label>
                            <input type="date" name="nascimentoCM"  class="form-control" id="nascimentoCM" placeholder="Seu aniversário ou data de fundação">
                        </div>
                          <br>
                          <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" name="emailCM"  class="form-control" id="emailCM" placeholder="Email">
                        </div>
                        <br>
                          <div class="form-group">
                            <label for="senha">Senha</label>
                            <input type="password" name="senhaCM"  class="form-control" id="senhaCM" placeholder="Sua senha deve ser maior que 6 caracteres">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="senha">Digite novamente sua senha</label>
                            <input type="password" name="senhaCM2"  class="form-control" id="senhaCM2" placeholder="Sua senha deve ser maior que 6 caracteres">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="telefone">Telefone</label>
                            <input type="tel" name="telefoneCM"  class="form-control" id="telefoneCM" placeholder="Numero de telefone">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="cpf">CPF ou CNPJ</label>
                            <input type="cpf" name="cpfcnpjCM"  class="form-control" id="cpfcnpjCM" placeholder="Seu CPF ou CNPJ">
                        </div>
                        <br>
                        <div class="form-check">
                            ...
                            Aceito os <a class="linkCad" href="">termos de uso</a>
                            </label>
                            <br>
                            <br>
...
<script>
    ...
    form.onsubmit = function travaForm(){
        ...
        var nomeval = document.getElementById('nomeCM').value; 
        var sobrenomeval = document.getElementById('sobrenomeCM').value ;
        var emailval = document.getElementById('emailCM').value ;
        var senha1val = document.getElementById('senhaCM').value ;
        var senha2val =  document.getElementById('senhaCM2').value;
        var telefoneval =  document.getElementById('telefoneCM').value ;
        var cpfval =  document.getElementById('cpfcnpjCM').value ;
        ...
        if(document.getElementById('nomeCM').value == '' && 
        document.getElementById('sobrenomeCM').value == '' &&
        document.getElementById('nascimentoCM').value == '' &&
        document.getElementById('emailCM').value == '' &&
        document.getElementById('senhaCM').value == '' &&
        document.getElementById('senhaCM2').value == '' &&
        document.getElementById('telefoneCM').value == '' &&
        document.getElementById('cpfcnpjCM').value == '' &&
        document.getElementById('termoUso').checked == false){

            document.getElementById('nomeCM').style.border = "1px solid red";
            document.getElementById('sobrenomeCM').style.border = "1px solid red";
            document.getElementById('nascimentoCM').style.border = "1px solid red";
            document.getElementById('emailCM').style.border = "1px solid red";
            document.getElementById('senhaCM').style.border = "1px solid red";
            document.getElementById('senhaCM2').style.border = "1px solid red";
            document.getElementById('telefoneCM').style.border = "1px solid red";
            document.getElementById('cpfcnpjCM').style.border = "1px solid red";
        ...
        if(document.getElementById('sobrenomeCM').value == ''){
        ...
        if(document.getElementById('nascimentoCM').value == ''){
        ...
        if( document.getElementById('emailCM').value == ''){
        ...
        if( document.getElementById('senhaCM').value == ''){
        ...
        if( document.getElementById('senhaCM2').value == ''){
        ...
        if(document.getElementById('telefoneCM').value == ''){

            document.getElementById('telefoneCM').style.border = "1px solid red";
            document.getElementById('hf').style.display = 'inline';
            return false;
        } //nao deixa enviar se o campo CPF estiver vazio 
        if( document.getElementById('cpfcnpjCM').value == ''){
        ...
        if(document.getElementById('termoUso').checked == false){
         ...
         if( document.getElementById('senhaCM').value != document.getElementById('senhaCM2').value){
